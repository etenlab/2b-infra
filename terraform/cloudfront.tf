resource "aws_cloudfront_distribution" "cdn" {
  comment             = "CDN for ${var.SUBDOMAIN}.${var.AWS_R53_ZONE}"
  ...
  aliases = ["${var.SUBDOMAIN}.${var.AWS_R53_ZONE}"]
...
output "aws_cloudfront_distribution_cdn_id" {
  value = aws_cloudfront_distribution.cdn.id
}

output "aws_cloudfront_distribution_cdn_address" {
